...
<body>
	<div>
		...
		<div style="position: absolute; text-align: left; top: 15%; left: 2%; width:325px;">
			...
			<h4>Telefono: <spam style="font-weight: normal;"><?php echo $telefono ?></spam></h4>
		...
		<div style="position: absolute; text-align: left; top: 15%; left: 70%; width:325px;">
			...
			<h4>Telefono: <spam style="font-weight: normal;"><?php echo $celular ?></spam></h4>
		...
		<div style="position: absolute; top: 70%; left: 2%; width: 98%; text-align: center; align-items: center;">
			<p>Gracias por escoger nuestro taller para su cotizacion esperemos verlo en el taller proximamente</p>
		</div>
</body>
</html>
